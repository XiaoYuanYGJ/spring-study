...
Source Server         : exam36
Source Server Version : 50717
Source Host           : 10.0.0.36:3306
...
CREATE TABLE `et_student_cj` (
  ...
  KEY `1` (`student_id`),
  KEY `2` (`kc_id`),
  CONSTRAINT `1` FOREIGN KEY (`student_id`) REFERENCES `et_student` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `2` FOREIGN KEY (`kc_id`) REFERENCES `et_student_kc` (`kc_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `et_student_sex_1` (
  ...
  PRIMARY KEY (`id`),
  KEY `w` (`stu_id`),
  CONSTRAINT `w` FOREIGN KEY (`stu_id`) REFERENCES `et_student` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `et_student_sex_2` (
  ...
  PRIMARY KEY (`id`),
  KEY `e` (`stu_id`),
  CONSTRAINT `e` FOREIGN KEY (`stu_id`) REFERENCES `et_student` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `et_student_xsz` (
  ...
  PRIMARY KEY (`xsz_id`),
  KEY `q` (`stu_id`),
  CONSTRAINT `q` FOREIGN KEY (`stu_id`) REFERENCES `et_student` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
